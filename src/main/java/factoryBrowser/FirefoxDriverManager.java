...
public class FirefoxDriverManager implements BrowserFactory {
    ...
    public WebDriver getBrowserDriver() {
        ...
        options.addPreference("browser.download.dir", GlobalConstants.getGlobalConstants().getDownloadPath());
        ...
        options.addPreference("browser.helperApps.neverAsk.saveToDisk",
                "multipart/x-zip,application/zip,application/x-zip-compressed,application/x-compressed," +
                        ...
                        "text/html,text/plain,application/excel,application/vnd.ms-excel,application/x-excel," +
